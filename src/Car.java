...
public class Car extends Transport {
    ...
    public Car(String brand, String model, double engineVolume, String color, int year, String country,
        ...
        super(brand,model,year,country,color,80);
    ...
    @Override
    public void refill() {
        System.out.println("Можно заправиться бензином, дизелем или зарядить электробатарею.");
    }
    ...
    public void printCar() {
        System.out.println(getBrand()+" "+getModel()+ ", сборка " +getCountry()+
                ", цвет кузова — " +getColor()+", объем двигателя — " +engineVolume+
                "л., год выпуска — "+getYear()+ "год, коробка передач - " + transmission+
